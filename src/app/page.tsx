...
import { featuredApi, popularApi, topRatedApi, trendingApi, upcomingApi } from "@/api/tmdb-api";
...
export default function Home({ }) {
  ...
  return (
    <>
      ...
      <SliderMovies title={"Upcoming Movies"} data={upcoming} loading={upcomingSuccess} />
      <SliderMovies title={"Trending Movies"} data={trending} loading={trendingSuccess} />
      <SliderMovies title={"Top Rated Movies"} data={topRated} loading={topRatedSuccess} />
      <SliderMovies title={"Popular Movies"} data={popular} loading={popularSuccess} />
    </>
  );
}
